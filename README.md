...
## $\textcolor{red}{Единственное\ я\ не\ понял\ почему\ мне\ не\ удалось\ зайти\ без\ пароля,\ пробовал\ различные\ вариации.\ Несколько\ раз\ удалял\ и\ создавал\ по\ новой\ учетку,\ пробовал\ прописать\ в\  nano\ /home/root/.my.cnf\ без\ толку.\ Буду\ благодарен\ услышать\ Вашу\ версию\ причины?\ Спасибо}$ 
 **************************************************************************
